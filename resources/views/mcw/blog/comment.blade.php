@foreach($comments as $comment)
    <li id="li-comment-{{ $comment->id }}" class="py-3 bg-white my-2" >
        <div id="comment-{{ $comment->id }}" class="flex ">
            ...
            <div class="comment_block w-full mx-auto">
                <div class="meta">
                    ...
                    <span class="reply float-right block">
                        <a class="comment-reply-link mr-3" href="#respond" onclick="return addComment.moveForm('comment-{{$comment->id}}','{{$comment->id}}','respond', '{{$comment->blog_post_id}}')">reply</a></span>
                </div>
